...
"""
def fuerzaBrutaMejorada(listaClientes: list, listaVentasActualizada: list, listaProductos: list):
    clientes, ventas, productos, categorias = cargar_datos(listaClientes, listaVentasActualizada, listaProductos)
    ...
    while bool:
        try:
            opcion = input(f"{bcolors.HEADER}{bcolors.UNDERLINE}Ingrese el número de la categoria (0 para salir):{bcolors.ENDC} ")
...
"""
def cargar_datos(listaClientes: list, listaVentasActualizada: list, listaProductos: list):
